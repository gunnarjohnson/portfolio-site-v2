				...
				{this.props.icons.map((icon, index) => (
					<span className={this.props.iconBlock + '__icon-title'} title={this.iconTitles[icon]} key={index}>
						{(icon === 'django' && <DjangoIcon iconClass={this.props.iconClass} />) ||
							...
							(icon === 'highcharts' && (
								<FontAwesomeIcon className={'icon ' + this.props.iconClass} icon={['fas', 'chart-bar']} />
							)) ||
							(icon === 'postcss' && <PostCssIcon iconClass={this.props.iconClass} />) ||
							(icon === 'postgresql' && <PostgreSQLIcon iconClass={this.props.iconClass} />) ||
							...
							(icon === 'coffee' && (
								<FontAwesomeIcon className={'icon ' + this.props.iconClass} icon={['fas', 'coffee']} />
							)) || <FontAwesomeIcon className={'icon ' + this.props.iconClass} icon={['fab', icon]} />}
					</span>
				))}
			</div>
		);
